				...
				<Animation animation={"animate__fadeInLeft"} threshold={0.4}>
					...
					<div className={s.btn_wrapper}>
						<Link to='section1' spy={true}
						      smooth={true}
						      offset={-80}
						      duration={1200} className={s.btn}>Learn more <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="#d9d6d6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m12 20l6-6m-6 6l-6-6m6 6V9.5M12 4v2.5"/></svg></Link>
					</div>
				</Animation>
			</div>
			<About/>
